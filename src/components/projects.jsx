...
const projectData = [
  {
    ...
    title: "EliteBluPrint",
    description:
      "Software Development Group Project: Developed a Machine Learning based web application that can generate 2D housing floor plans using natural language input (NLP). The application allows users to generate floor plans, view the generated floor plans, and download the generated floor plans",
    techStack: [
      "React JS",
      "Mongo DB",
      "Firebase",
...
const ProjectCard = ({ project }) => (
  <div className="flex flex-col bg-white-A700 rounded-lg shadow-md p-5 hover:shadow-lg transition-shadow">
    ...
    <div className="flex flex-col p-5">
      <Text className="text-xl text-black-900 mb-2" size="txtSoraBold32">
        {project.title}
      </Text>
      <Text className="text-sm text-black-900 mb-4" size="txtSoraRegular16">
        {project.description}
      </Text>
      <div className="flex flex-wrap gap-2 mb-4">
        {project.techStack.map((tech, index) => (
          <Button
            key={index}
            shape="round"
            className="font-medium  text-white-A700 min-w-[79px]"
          >
            {tech}
          </Button>
        ))}
      ...
      <div className="flex w-full items-end justify-end">
        <a
          ...
          className="text-black flex items-center hover:text-blue-500"
        >
